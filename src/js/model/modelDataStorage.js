  ...
  sections: [
    {
      ...
      tooltips: [
        ...
        <ul>User credentials refer to <i>the information used by a user to prove their identity</i> during the authentication process. This typically includes:
        ...
        <p>In some cases, <i>additional credentials might be required, such as security questions or biometric data</i>, depending on the authentication method being used. It's essential for users to keep their credentials secure to prevent unauthorized access to their accounts.</p>
...
app.use(async (req, res, next) => {
  ...
  next();
    ...
    {
      sectionTitle: 'Authentication With OAuth Google and Passport.js',
      sectionSource: '',
      highlights: {
        highlight1: ['Passport.js'],
        highlight2: ['OAuth Google'],
      },
      tooltips: [
        `
        <pre><code>
